      ...
      <div className="wrap footer-inner">
        <div>
          ...
          <ul className="footer-contacts">
            ...
            <li><a className="footer-link" href="/about">{t("footerAbout")}</a></li>
          </ul>
          <p className="footer-legal">
            <a href="/oferta">{t("ofertaTitle")}</a> · <a href="/privacy">{t("privacyTitle")}</a> · <a href="/consent">{t("consentPageTitle")}</a>
          </p>
        </div>
